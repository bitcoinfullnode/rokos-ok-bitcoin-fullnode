...
var NRS = (function (NRS, $, undefined) {
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    var data = {
                                        ...
                                        "asset_name": asset.name,
                                        "quantity": [transaction.attachment.quantityQNT, asset.decimals],
                                        "price_formatted_html": NRS.formatOrderPricePerWholeQNT(transaction.attachment.priceNQT, asset.decimals) + " HZ",
                                        "total_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(transaction.attachment.quantityQNT, transaction.attachment.priceNQT)) + " HZ"
                                    };
                                    data["sender"] = transaction.senderRS ? transaction.senderRS : transaction.sender;
                                    $("#transaction_info_table").find("tbody").append(NRS.createInfoTable(data));
                                    $("#transaction_info_table").show();
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    var data = {
                                        ...
                                        "asset_name": asset.name,
                                        "amount_per_share": NRS.formatOrderPricePerWholeQNT(transaction.attachment.amountNQTPerQNT, asset.decimals) + " HZ",
                    ...
                    case 2:
                        ...
                        NRS.sendRequest("getDGSGood", {
                            ...
                            var data = {
                                ...
                                "item_name": goods.name,
                                "new_price_formatted_html": NRS.formatAmount(transaction.attachment.priceNQT) + " HZ",
                                "seller": NRS.getAccountFormatted(goods, "seller")
                            };
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                if (purchase.quantity != "1") {
                                    ...
                                    data["total_formatted_html"] = orderTotal + " HZ";
                                }
                    ...
                    case 7:
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                data["order_total_formatted_html"] = NRS.formatAmount(orderTotal) + " HZ";
                ...
                switch (transaction.subtype) {
                    case 0:
                        ...
                        var data = {
                            ...
                            "min_reserve_per_unit_formatted_html": NRS.formatAmount(minReservePerUnitNQT) + " HZ",
                        ...
                        if (currency) {
                            ...
                            data["current_reserve_per_unit_formatted_html"] = NRS.formatAmount(currentReservePerUnitNQT) + " HZ";
                        } else {
                    ...
                    case 1:
                        if (currency) {
                            ...
                            var data = {
                                ...
                                "amount_per_unit_formatted_html": NRS.formatAmount(amountPerUnitNQT) + " HZ",
                                "reserved_amount_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(amountPerUnitNQT, NRS.convertToQNTf(resSupply, currency.decimals))) + " HZ"
                            };
                        } else {
                    ...
                    case 2:
                        if (currency) {
                            ...
                            var data = {
                                ...
                                "claimed_amount_formatted_html": NRS.formatAmount(NRS.convertToQNTf(NRS.calculateOrderTotalNQT(currentReservePerUnitNQT, transaction.attachment.units), currency.decimals)) + " HZ"
                            };
                        } else {
                            data = NRS.getUnknownCurrencyData(transaction);
                        }
    ...
    NRS.formatAssetOrder = function (asset, transaction, isModalVisible) {
        ...
        NRS.sendRequest("getOrderTrades", params, function (response) {
            ...
            data["total_traded"] = NRS.formatAmount(tradeTotal, false, true) + " HZ";
        }, null, false);
    ...
    NRS.formatCurrencyExchange = function (currency, transaction, type) {
        var rateUnitsStr = " [ " + currency.code + " / HZ ]";
        var data = {
            ...
            "total_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(transaction.attachment.units, transaction.attachment.rateNQT)) + " HZ"
        };
        var rows = "";
        NRS.sendRequest("getExchangesByExchangeRequest", {
            ...
            data["total_exchanged"] = NRS.formatAmount(exchangedTotal, false, true) + " [HZ]";
        }, null, false);
        return data;
    };
