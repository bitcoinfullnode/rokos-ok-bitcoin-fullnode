...
public class ManifestGenerator {
    ...
    public static void main(String[] args) {
        ...
        manifestGenerator.generate("./resource/horizon.manifest.mf", Nxt.class.getCanonicalName(), "./lib");
        ...
        manifestGenerator.generate("./resource/hzservice.manifest.mf", serviceClassName, "./lib");
    }
